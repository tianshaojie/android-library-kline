...
<div class='row'>
        <img src='https://github.com/tianshaojie/android-library-kline/blob/master/img/demo.gif' width="300px"/>
</div>

* 支持自定义样式
<div class='row'>
        <img src='https://github.com/tianshaojie/android-library-kline/blob/master/img/style1.png' width="300px"/>
        <img src='https://github.com/tianshaojie/android-library-kline/blob/master/img/style2.png' width="300px"/>
</div>
